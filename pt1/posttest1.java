...
public class posttest1 {
    ...
    public static int tampil(String aksi) {
        if (daftarResep.size() == 0) {
            ...
            for (int i = 0; i < daftarResep.size(); i++) {
                System.out.println((i + 1) + ". " + daftarResep.get(i).nama);
            }
    ...
    public static void tampilResep() {
        ...
        if (urutan > daftarResep.size()) {
            ...
            System.out.println("Nama resep: " + resep.nama);
            System.out.println("Bahan-bahan: " + String.join(", ", resep.bahan));
            System.out.println("Langkah-langkah: ");
            for (int i = 0; i < resep.langkah.size(); i++) {
                System.out.println((i + 1) + ". " + resep.langkah.get(i));
            }
            scanner.nextLine(); kembali();
        }
    }
